...
function MapCarosel2() {
  ...
  return (
    <div style={{ padding: "40px 0px 40px 0px" }}>
        <Box w={"80%"} margin={"auto"} className="App" padding={"30px"} boxShadow="rgba(0, 0, 0, 0.07) 0px 1px 2px, rgba(0, 0, 0, 0.07) 0px 2px 4px, rgba(0, 0, 0, 0.07) 0px 4px 8px, rgba(0, 0, 0, 0.07) 0px 8px 16px, rgba(0, 0, 0, 0.07) 0px 16px 32px, rgba(0, 0, 0, 0.07) 0px 32px 64px;">
